  ...
  <div class="login">
    ...
    <div class="loginBox">
      ...
      <div class="loginCon">
        <div class="titleDiv">
          <h3>Sign up now</h3>
          <p>Enter your phone and password to log on:</p>
...
export default {
  ...
  methods: {
    ...
    async _login() {
      let {code,data,msg} = await login(this.ruleForm);
      console.log(code);
      console.log(data);
      console.log(msg);
      if(code==200){
        ...
        this.$store.dispatch("user/setToken", this.ruleForm.phone);
        this.$store.dispatch("user/setName", this.ruleForm.phone);
