...
export const asyncRoutes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { title: "注册码", icon: "el-icon-s-tools" }
      }
    ]
  },
  {
    ...
    meta: { icon: "el-icon-s-marketing", title: "比赛管理" },
    children: [
      {
        path: "slide-chart",
        name: "Sldie-chart",
  ...
  },
  {
    ...
    meta: { icon: "el-icon-coin", title: "APP首页轮播图" },
    children: [
      {
        path: "upload",
        name: "Upload",
        component: () => import("@v/components/pushImg"),
        meta: { icon: "el-icon-upload", title: "APP轮播图管理" }
      }
    ]
  },
